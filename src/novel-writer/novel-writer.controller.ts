...
import { UpdateNovelWriterRequestDto } from './dto/request/update-novel-writer.dto';
...
export class NovelWriterController {
  ...
  @Get('')
  async findNovelText(@Query('novelRoomId') novelRoomId: number) {
  ...
  create(
    ...
    return this.novelWriterService.create(dto.toEntity(user));
  }
